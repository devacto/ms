...
-- 2. Convert to AVRO
CREATE STREAM clickstream_avro WITH (KAFKA_TOPIC='clickstream_avro',VALUE_FORMAT='AVRO') AS SELECT * FROM clickstream WHERE user_id IS NOT NULL PARTITION BY user_id;